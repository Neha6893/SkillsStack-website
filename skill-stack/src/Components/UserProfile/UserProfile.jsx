...
function UserProfile() {
  ...
  const { logout } = useContext(UserContext); // ✅ added: get logout from context
  ...
  return (
    <>
      <Nav />
      <div className="max-w-5xl mx-auto mt-10 p-6 bg-white rounded-xl shadow-md mb-10">
        ...
        <div className="flex items-center gap-6 mb-10">
          ...
          <div>
            <p className="font-semibold text-lg">{name || "Guest User"}</p>
            <p className="text-gray-500">{mail || "No email available"}</p>
          </div>
        </div>
